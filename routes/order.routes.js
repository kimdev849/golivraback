...
router.post('/', authMiddleware, requireRoles(['client', 'admin']), requireFeature('orders'), createOrder);
router.post('/:orderId/pay', authMiddleware, requireRoles(['client', 'admin']), requireFeature('payments'), payOrder);
